...
const Store = () => {
    const apiUrl = 'http://127.0.0.1:5000/store'
    const urlField = "Name"
    const pkField = "StoreID"
    const listField = "stores"
    const emptyRow = {StoreID:"",Name:"",Code:"",State:""}
            ...
            <Container maxWidth="xs">
                <form>
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            <TextField label="StoreID" name="StoreID" value={formData?.StoreID} onChange={handleChange} fullWidth variant="outlined"  InputLabelProps={{shrink:true}} disabled={true} />
                        </Grid>
                        <Grid item xs={12}>
