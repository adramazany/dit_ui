...
const Category = () => {
    ...
    const urlField = "Name"
    const pkField = "CategoryID"
    const listField = "categories"
    const emptyRow = {CategoryID:"",Name:"",Code:"",PricingMethod:""}
            ...
            <Container maxWidth="xs">
                <form>
                    <Grid container spacing={2}>
                        <Grid item xs={12}>
                            <TextField label="CategoryID" name="CategoryID" value={formData?.CategoryID} onChange={handleChange} fullWidth variant="outlined"  InputLabelProps={{shrink:true}} disabled={true} />
                        </Grid>
                        <Grid item xs={12}>
                        ...
                        <Grid item xs={12}><TextField label="PricingMethod" name="PricingMethod" value={formData?.PricingMethod} onChange={handleChange} fullWidth variant="outlined"  InputLabelProps={{ shrink: true }}/></Grid>
                        <Grid item xs={12}>
