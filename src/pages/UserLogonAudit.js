...
const UserLogonAudit = () => {
    const apiUrl = 'http://127.0.0.1:5000/userlogonaudit'
    const urlField = "UserLogonAuditID"
    const pkField = "UserLogonAuditID"
    const listField = "userlogonaudits"
    const emptyRow = {UserLogonAuditID:"",UserRef:'',LogonTime:'',LogonSource:'',SessionID:'',LogoutReason:'',LogoutTime:'',LastActivityTime:'',Version:''}
